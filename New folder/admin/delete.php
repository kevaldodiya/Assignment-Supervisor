...
<div class="container-fluid text-center">    
  <div class="row content">
     ...
     <h3><strong><u>Delete Tasks</u></strong></h3>
...
<br>
  ...
  <form action="index.php" method="post">
    ...
    <label>Category</label>
         <input list="category" name="cat" placeholder="Category" id="cat" value = "<?php echo $db_cat;?>" onkeyup="myFunction()" disabled>
<script>
     function myFunction() {
...
<br><label>Assigning Date</label>&nbsp;&nbsp;
 ...
 <label>Deadline</label>&nbsp;
   <input type="date" name="ddate" value="<?php echo $db_ddate;?>" disabled>
 
<br><br>
<label>Description</label><br>

 <textarea name="desc" rows="6" cols="50" disabled><?php echo $db_desc;?></textarea> <br>
