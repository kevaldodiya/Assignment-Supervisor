...
<div class="container-fluid text-center">    
  <div class="row content">
     <h3><strong><u>Grant Privilege To User</u></strong></h3>
...
<br>
  ...
  <form action="users.php" method="post">
     <br>
      ...
      <br>
    <br>  
      <label>Access &nbsp;&nbsp;</label> <br>    <input list="acc" name="access"  value="<?php echo $acc ;?>">
      <br>
      <datalist id="acc">
  <option value="Yes">
  <option value="No">
    ...
    <input type="submit" value="Grant/Revoke" name="gr">
  </form>
</div>
